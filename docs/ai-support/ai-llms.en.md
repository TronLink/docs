...
- [llms.txt](https://docs.tronlink.org/llms.txt) — a curated index of this documentation, following the [llmstxt.org](https://llmstxt.org/) standard
- [llms-full.txt](https://docs.tronlink.org/llms-full.txt) — the full text of every English page, bundled for single-fetch ingestion
